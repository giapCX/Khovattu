                ...
                <div class="pagination flex items-center justify-center space-x-1">
                    ...
                    <c:choose>
                        <c:when test="${currentPage > 1}">
                            <a href="ListProposalServlet?page=${currentPage - 1}&searchType=${param.searchType}&searchStatus=${param.searchStatus}&searchStartDate=${param.searchStartDate}&searchEndDate=${param.searchEndDate}" class="px-3 py-1 rounded bg-gray-300 hover:bg-gray-400">&lt;</a>
                        </c:when>
                        <c:otherwise>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <a href="ListProposalServlet?page=1&searchType=${param.searchType}&searchStatus=${param.searchStatus}&searchStartDate=${param.searchStartDate}&searchEndDate=${param.searchEndDate}" class="px-3 py-1 rounded border hover:border-blue-500">1</a>
                        </c:otherwise>
                    </c:choose>
                    ...
                    <c:forEach var="i" begin="${currentPage - 1 > 1 ? currentPage - 1 : 2}" end="${currentPage + 1 < totalPages ? currentPage + 1 : totalPages - 1}">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a href="ListProposalServlet?page=${i}&searchType=${param.searchType}&searchStatus=${param.searchStatus}&searchStartDate=${param.searchStartDate}&searchEndDate=${param.searchEndDate}" class="px-3 py-1 rounded border hover:border-blue-500">${i}</a>
                            </c:otherwise>
                        </c:choose>
                    </c:forEach>
                    ...
                    <c:if test="${totalPages > 1}">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a href="ListProposalServlet?page=${totalPages}&searchType=${param.searchType}&searchStatus=${param.searchStatus}&searchStartDate=${param.searchStartDate}&searchEndDate=${param.searchEndDate}" class="px-3 py-1 rounded border hover:border-blue-500">${totalPages}</a>
                            </c:otherwise>
                        </c:choose>
                    </c:if>
                    <!-- Nút trang sau -->
