    ...
    <main class="flex-1 p-8 transition-all duration-300">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            <div class="card bg-white dark:bg-gray-800 animate-fadeInUp delay-300">
                ...
                <div class="bg-gray-50 dark:bg-gray-700 px-6 py-4">
                    <a href="${pageContext.request.contextPath}/proposals?status=pending" class="text-sm font-medium text-primary-600 dark:text-primary-400 hover:underline">View All</a>
                </div>
            </div>
        </div>
        <!-- Charts Row -->
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            <div class="lg:col-span-2 card bg-white dark:bg-gray-800 p-6">
                <div class="flex justify-between items-center mb-4">
                    <div>
                        <h2 class="text-xl font-semibold text-gray-800 dark:text-white">Average Import Price by Month (2025)</h2>
                        <p class="text-sm text-gray-600 dark:text-gray-300">Average price per unit of imported materials by month</p>
                    </div>
                </div>
                <canvas id="importPriceChart" class="border rounded-lg"></canvas>
            </div>
<!--            <div class="card bg-white dark:bg-gray-800 p-6">
    ...
    <script>
        ...
        const prices = Array(12).fill(0);
        <c:forEach var="item" items="${averageImportPrices}">
            prices[${item.materialName.split(' ')[1] - 1}] = ${item.pricePerUnit != null ? item.pricePerUnit : 0};
        </c:forEach>
        console.log('Average Import Price Data:', {months, prices});

        const importPriceCtx = document.getElementById('importPriceChart').getContext('2d');
        new Chart(importPriceCtx, {
            type: 'bar',
            data: {
                labels: months,
                datasets: [{
