...
public class DetailProposalServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DetailProposalServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DetailProposalServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        Integer proposalId = Integer.parseInt(request.getParameter("proposalId"));
         try (Connection conn = DBContext.getConnection()) {
            ...
            ProposalApprovals proApp = proposalDAO.getApprovalByProposalId(proposalId);
