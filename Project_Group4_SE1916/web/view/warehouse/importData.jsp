...
<body class="bg-gray-50 min-h-screen font-sans antialiased">
    ...
    <main class="flex-1 p-8 transition-all duration-300">
                ...
                <div class="w-full flex justify-center">
                    <div class="w-full max-w-6xl bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 mb-6">
                        ...
                        <div class="space-y-2 mt-4">
                            <label class="font-semibold">Import Date</label>
                            <input type="date" name="importDate" value="<fmt:formatDate value="<%= new java.util.Date() %>" pattern="yyyy-MM-dd" />"
        ...
        <div class="mt-6 flex justify-center gap-4 max-w-2xl mx-auto w-full">
            <div class="w-1/3">
                <a href="${pageContext.request.contextPath}/ListProposalExecute?filter=import_only" 
