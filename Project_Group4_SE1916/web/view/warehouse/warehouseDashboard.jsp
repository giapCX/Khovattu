    ...
    <body class="bg-gray-50 min-h-screen font-sans antialiased">
        ...
        <aside id="sidebar" class="sidebar w-72 text-white p-4 fixed h-full z-50">
            ...
            <nav class="space-y-1">
                ...
                <a href="${pageContext.request.contextPath}/ListProposalServlet" class="nav-item flex items-center p-2 justify-between">
                    <div class="flex items-center">
                        <i class="fas fa-clipboard-list mr-2 w-5 text-center"></i>
                        <span class="text-base">Xem lịch sử Yêu cầu xuất/nhập/sửa</span>
                    </div>
